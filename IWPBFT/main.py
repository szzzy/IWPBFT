...
run_IWPBFT(nodes=nodes,proportion=1,checkpoint_frequency0=checkpoint_frequency,clients_ports0=clients_ports,timer_limit_before_view_change0=timer_limit_before_view_change)
...
for i in range (requests_number):
    ...
    time.sleep(10) #Exécution plus rapide lorsqu'on attend un moment avant de lancer la requête suivante