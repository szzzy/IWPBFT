...
def type_node():
    while True:
        sign.define_type_of_node(type_nodes)
        global num_node
        num_node = input()
...
def prepare():
    sign.save_file('messages_formats/type_format.json', {})
...
run_WPBFT(nodes=nodes, proportion=1, checkpoint_frequency0=checkpoint_frequency, clients_ports0=clients_ports,
